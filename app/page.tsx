  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 text-slate-900 dark:text-white">
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-gradient-to-br from-blue-50 via-white to-green-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
        ...
        <div className="container relative px-4 py-20 md:py-32 z-10">
      ...
      {/* Features Section */}
      <section id="features" className="container px-4 py-32 bg-gradient-to-b from-white via-blue-50/30 to-white dark:from-slate-900 dark:via-slate-800/30 dark:to-slate-900">
      ...
      <section className="container px-4 py-32 bg-white dark:bg-slate-900">
        <div className="mx-auto max-w-7xl">
